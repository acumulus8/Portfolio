  ...
  _createClass(Lightbox, [{
    ...
    value: function closeLightbox() {
      ...
      this.xBtn.on("click", function () {
        return that.lightbox.removeClass(that.classToToggle);
      });
...
;// CONCATENATED MODULE: ./app/assets/scripts/Lightbox.js


new modules_Lightbox(jquery_default()('.js-lightbox'), jquery_default()('.js-certs-btn'), jquery_default()('.js-x-cert'), 'lightbox--is-visible');
new modules_Lightbox(jquery_default()('.js-resume'), jquery_default()('.js-resume-btn'), jquery_default()('.js-x-resume'), 'resume--is-visible');
})();
