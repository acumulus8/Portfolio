...
function FormValidate_typeof(o) { "@babel/helpers - typeof"; return FormValidate_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, FormValidate_typeof(o); }
...
function HideHeader_typeof(o) { "@babel/helpers - typeof"; return HideHeader_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, HideHeader_typeof(o); }
...
function ImageCarousel_typeof(o) { "@babel/helpers - typeof"; return ImageCarousel_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, ImageCarousel_typeof(o); }
...
function RevealOnScroll_typeof(o) { "@babel/helpers - typeof"; return RevealOnScroll_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, RevealOnScroll_typeof(o); }
...
function MobileMenu_typeof(o) { "@babel/helpers - typeof"; return MobileMenu_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, MobileMenu_typeof(o); }
...
;// CONCATENATED MODULE: ./app/assets/scripts/modules/Lightbox.js
function Lightbox_typeof(o) { "@babel/helpers - typeof"; return Lightbox_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, Lightbox_typeof(o); }
...
function BackgroundHeight_typeof(o) { "@babel/helpers - typeof"; return BackgroundHeight_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, BackgroundHeight_typeof(o); }
...
var BackgroundHeight = /*#__PURE__*/function () {
  ...
  BackgroundHeight_createClass(BackgroundHeight, [{
    key: "waitForImagesToLoad",
    value: function waitForImagesToLoad() {
      var _this = this;
      var images = this.pageContent.querySelectorAll("img");
      var onImageLoad = function onImageLoad() {
        _this.adjustSubBackgroundHeight();
        _this.adjustBackgroundsTopOffset();
      };
    ...
    value: function adjustBackgroundsTopOffset() {
      if (this.gradientBackground && this.subBackground) {
        ...
        if (this.secondaryNav) {
          var _this$secondaryNav, _this$secondaryNav2;
          gradientOffset += (_this$secondaryNav = this.secondaryNav) === null || _this$secondaryNav === void 0 ? void 0 : _this$secondaryNav.offsetHeight;
          subOffset += (_this$secondaryNav2 = this.secondaryNav) === null || _this$secondaryNav2 === void 0 ? void 0 : _this$secondaryNav2.offsetHeight;
        }
...
;// CONCATENATED MODULE: ./app/assets/scripts/modules/ProjectShade.js
function ProjectShade_typeof(o) { "@babel/helpers - typeof"; return ProjectShade_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, ProjectShade_typeof(o); }
function ProjectShade_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function ProjectShade_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, ProjectShade_toPropertyKey(descriptor.key), descriptor); } }
function ProjectShade_createClass(Constructor, protoProps, staticProps) { if (protoProps) ProjectShade_defineProperties(Constructor.prototype, protoProps); if (staticProps) ProjectShade_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function ProjectShade_toPropertyKey(arg) { var key = ProjectShade_toPrimitive(arg, "string"); return ProjectShade_typeof(key) === "symbol" ? key : String(key); }
function ProjectShade_toPrimitive(input, hint) { if (ProjectShade_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (ProjectShade_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var ProjectShade = /*#__PURE__*/function () {
  function ProjectShade(shade, showShadeBtn, hideShadeBtn, shadedArticle) {
    ProjectShade_classCallCheck(this, ProjectShade);
  ...
  ProjectShade_createClass(ProjectShade, [{
    key: "init",
    value: function init() {
    ...
    key: "showShade",
    value: function showShade(e) {
      var _this = this;
      e.preventDefault();
      setTimeout(function () {
        _this.projectShade.classList.remove("project--professional__shade--hidden");
        _this.projectShade.classList.add("project--professional__shade--revealed");
        _this.shadedArticle.classList.remove("project--professional--revealed");
        _this.shadedArticle.classList.add("project--professional--hidden");
        _this.showShadeBtn.style.display = "none";
        _this.hideShadeButton.style.display = "block";
      }, 250);
    }
  }]);
  return ProjectShade;
}();
/* harmony default export */ const modules_ProjectShade = (ProjectShade);
...
function loadAboutPageJS() {
  ...
  new modules_SmoothScroll(jquery_default()("#my-story-link"));
  new modules_ImageCarousel();
}
function loadPortfolioPageJS() {
  var allShadedArticles = document.querySelectorAll(".project--professional");
  var allShades = document.querySelectorAll(".project--professional__shade");
  console.log("allShades", allShades);
  var allShowShadeButtons = document.querySelectorAll("#show-shade-btn");
  var allHideShadeButtons = document.querySelectorAll("#hide-shade-btn");
  var shadeButtonGroups = [];
  for (var i = 0; i < allShades.length; i++) {
    ...
    new modules_SmoothScroll(jquery_default()("#".concat(allShowShadeButtons[i].id, " a")));
    new modules_SmoothScroll(jquery_default()("#side-projects-link"));
  }
  shadeButtonGroups.forEach(function (group) {
    console.log(group);
    new modules_ProjectShade(group.shade, group.showShadeBtn, group.hideShadeBtn, group.shadedArticle);
  });
  new modules_Lightbox(document.getElementsByClassName("js-lightbox")[0], document.getElementsByClassName("js-certs-btn")[0], document.getElementsByClassName("js-x-cert")[0], "lightbox--is-visible");
  new modules_Lightbox(document.getElementsByClassName("js-resume")[0], document.getElementsByClassName("js-resume-btn")[0], document.getElementsByClassName("js-x-resume")[0], "resume--is-visible");
}
function loadJSonUrlChange() {
  ...
  var isIndexPage = currentURL.includes("index") || currentURL.endsWith("/") || currentURL.endsWith(".com") || !currentURL.includes("about") && !currentURL.includes("portfolio") && !currentURL.includes("contact");
  if (isIndexPage) {
